...
public class MoneyKeeperActivity extends FragmentActivity implements ViewPager.OnPageChangeListener, TabHost.OnTabChangeListener {
    private FragmentTabHost mTabHost;
    private LayoutInflater layoutInflater;
    private Class fragmentArray[] = {LessonOneFragment.class, LessonTwoFragment.class, LessonThreeFragment.class, LessonFourFragment.class};
    private int imageViewArray[] = {R.drawable.tab_pencil_btn, R.drawable.tab_calendar_btn, R.drawable.tab_pie_btn, R.drawable.tab_setting_btn};
    private String textViewArray[] = {"新增", "日曆", "分析", "設定"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_money_keeper);
    ...
    private void initPage() {
        LessonOneFragment fragment1 = new LessonOneFragment();
        LessonTwoFragment fragment2 = new LessonTwoFragment();
        LessonThreeFragment fragment3 = new LessonThreeFragment();
        LessonFourFragment fragment4 = new LessonFourFragment();
    ...
    private View getTabItemView(int i) {
        //将xml布局转换为view对象
        View view = layoutInflater.inflate(R.layout.fragment_layout, null);
